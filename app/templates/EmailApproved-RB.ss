...
<html lang="en">
    ...
    <body>
        <h3 class="text-center">Approved RB by ($From)</h3>
        <p class="text-center">RB Anda dengan kode $RB.Kode telah di Approve oleh $From<% if $RB.DraftRB.Status.ID == 9 %> dan sedang di proses menjadi PO<% end_if %></p>
		</p>
		<% with $RB %>
