...
<html lang="en">
    ...
    <body>
        <h3 class="text-center">Rejected Draf RB/RB</h3>
        <p class="text-center">Anda telah melakukan Reject pada Draf RB/RB dengan kode Draf RB/RB $DRB.Kode </p>
		<% with $DRB %>
		<p>Berikut Data Draf RB/RB $Kode: </p>
	...
	<br>
	<p class="text-center">Klik link berikut untuk melihat Draf RB/RB yang Anda Reject	</p>
