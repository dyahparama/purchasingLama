...
<html lang="en">
    ...
    <body>
        <h3 class="text-center">Approval RB</h3>
        <p class="text-center">RB dari ($From) dengan kode $RB.Kode</p>
		<p class="text-center">membutuhkan approval dari Anda sebagai ($Jabatan)
		</p>
		<% with $RB %>
