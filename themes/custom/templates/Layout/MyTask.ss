            ...
            <div class="example-wrap">
              <div class="nav-tabs-horizontal nav-tabs-inverse" data-plugin="tabs">
                <ul class="nav nav-tabs" role="tablist">
	                ...
	                <li class="nav-item" role="presentation">
                    	<a class="nav-link" data-toggle="tab" href="#listpo" aria-controls="listpo" role="tab"><span>PO</span> <span class="badge badge-pill badge-dark">5</span>
                		</a>
                  	</li>
	                <li class="nav-item" role="presentation">
                	...
                	<table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable" id="dataTablepo">
		              	...
		              	<tbody>
			                <tr>
				                ...
				                <td>
				                  	<div class="btn-group">
									  <a type="button" class="btn btn-default viewpo" shownya='0' idnya="1"><i class="text-info fa fa-eye"></i> Lihat Detail</a>
									  <!-- <a href="'$delete_link'" type="button" class="btn btn-danger delete"><i class="text-info fa fa-eye"></i> Delete</a> --> 					 
									</div>
				                </td>
			                </tr>
		              	...
		              	<tbody>
			                ...
			                <tr class="showdetail1 no-sort" style="display: none;">
			                	...
			                	<td>
			                		<div class="btn-group">
									  <a type="button" class="btn btn-default viewpo" shownya='0' idnya="1"><i class="text-info fa fa-eye"></i> View PO</a>
									  <!-- <a href="'$delete_link'" type="button" class="btn btn-danger delete"><i class="text-info fa fa-eye"></i> Delete</a> --> 					 
									</div>
			                	</td>
			                	<td></td>
