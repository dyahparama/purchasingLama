<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
	...
	<div class="navbar-header">
	  ...
	  <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
		<img class="navbar-brand-logo" src="/_resources/themes/custom/assets/images/logo.png" title="Purchasing System">
	  ...
	  <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
		...
		<ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
		  ...
		  <li class="nav-item dropdown">
			...
			<div class="dropdown-menu" role="menu">
			  <a class="dropdown-item" href="{$BaseHref}prfl" role="menuitem"><i class="icon md-account" aria-hidden="true"></i> Profile</a>
					  ...
					  <div class="media">
						<div class="pr-10">
						  <span class="avatar avatar-sm avatar-off">
							<img src="/_resources/themes/custom/global/portraits/3.jpg" alt="..." />
							<i></i>
						  </span>
						</div>
						<div class="media-body">
